...
const translations = {
    en: {
        about: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/about.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">About.exe', role: '🎨 GRAPHIC DESIGNER & WEB DEVELOPER', intro: 'Specializing in UI/UX Design, 3D Modeling, and Interactive Web Experiences. Based in Santa Maria Capua Vetere, Italy.', exp: '💼 EXPERIENCES', form: '🎓 FORMATION', skills: '⚡ SKILLS', download: '📥 DOWNLOAD CV' },
        projects: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/projects.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">Projects.exe', description: 'Modern design system with responsive components and accessibility features.' },
        contact: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/contact.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">Contact.exe', getInTouch: 'GET IN TOUCH', location: '📍 Location: Santa Maria Capua Vetere, Campania, Italy', email: '✉️ Email:', linkedin: '💼 LinkedIn:', github: '🐙 GitHub:', website: '🌐 Website:', sendMessage: '✉️ SEND MESSAGE', yourName: 'Your Name:', yourEmail: 'Your Email:', subject: 'Subject:', message: 'Message:', sendBtn: '📤 SEND EMAIL' },
        game: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/game.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">Snake.exe' },
        info: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/readme.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">ReadMe.txt', role: '🎨 GRAPHIC DESIGNER & WEB DEVELOPER', intro: 'Specializing in UI/UX Design, 3D Modeling, and Interactive Web Experiences. Based in Santa Maria Capua Vetere, Italy.', exp: '💼 EXPERIENCES', form: '🎓 FORMATION', skills: '⚡ SKILLS', download: '📥 DOWNLOAD CV' },
        icons: { about: 'About.exe', projects: 'Projects.exe', contact: 'Contact.exe', game: 'Game.exe', info: 'ReadMe.txt' }
    },
    it: {
        about: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/about.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">Chi Sono.exe', role: '🎨 GRAPHIC DESIGNER & WEB DEVELOPER', intro: 'Specializzato in UI/UX Design, Modellazione 3D ed Esperienze Web Interattive. Basato a Santa Maria Capua Vetere, Italia.', exp: '💼 ESPERIENZE', form: '🎓 FORMAZIONE', skills: '⚡ COMPETENZE', download: '📥 SCARICA CV' },
        projects: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/projects.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">Progetti.exe', description: 'Sistema di design moderno con componenti responsive e funzioni di accessibilità.' },
        ...
        game: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/game.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">Snake.exe' },
        info: { title: '<img src="/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Icons/readme.png" style="width: 16px; height: 16px; margin-right: 5px; vertical-align: middle;">Leggimi.txt', role: '🎨 GRAPHIC DESIGNER & WEB DEVELOPER', intro: 'Specializing in UI/UX Design, 3D Modeling, and Interactive Web Experiences. Based in Santa Maria Capua Vetere, Italy.', exp: '💼 EXPERIENCES', form: '🎓 FORMATION', skills: '⚡ SKILLS', download: '📥 DOWNLOAD CV' },
...
const projectData = {
                'project-01': {
                    ...
                    gallery: [
                        '/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Imgs/Prjct_01/1.png', // Immagine 1
                        '/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Imgs/Prjct_01/2.png', // Immagine 2
                        '/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Imgs/Prjct_01/3.png', // Immagine 3
                        '/Users/gennarogrieco/Documents/Projects/Portfolio/Portfolio/Imgs/Prjct_01/4.png'
                    ]
                },
                'project-02': {
                    style: {
